...
const createGame = (req, res) => {
    ...
    if (req.body.description) { gameFields.description = req.body.description; }
...
const updateGameById = (req, res) => {
    ...
    Game.findById(req.params.id)
        .then((game) => {
            ...
            if (req.body.participants) { game.participants = req.body.participants; }
...
module.exports = { getAllGames, getGameById, createGame, updateGameById, deleteGameById };
